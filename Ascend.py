...
class Price(unittest.TestCase):
	...
	# def __init__(self):
	# 	print("Price object created")

	def testget_pjm_price(self):
...
class TestGetPriceOfReport(unittest.TestCase):
	def test_runTest(self):		
		price = Price()
		self.assert_Equal(price.testget_pjm_price(), "15,001.00", "incorrect value for price")
